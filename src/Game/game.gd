...
func new_game() -> void:
	...
	_add_player_start_equipment("bow")
	_add_player_start_equipment("lightning_scroll")
	_add_player_start_equipment("fireball_scroll")
	_add_player_start_equipment("confusion_scroll")
